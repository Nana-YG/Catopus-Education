...
abstract class AppLocalizations {
  ...
  /// No description provided for @teacherChooseClass.
  ///
  /// In en, this message translates to:
  /// **'Choose Your Class (Teacher)'**
  String get teacherChooseClass;

  /// No description provided for @studentChooseClass.
  ///
  /// In en, this message translates to:
  /// **'Choose Your Class (Student)'**
  String get studentChooseClass;
