define z1 = Character('小张_正常')
define z2 = Character('小张_思考')
define z3 = Character('小张_不解')
define z4 = Character('小张_快乐')
define z5 = Character('小张_难过')
define z6 = Character('小张_无语')

define m1 = Character('毛毛_正常')
define m2 = Character('毛毛_思考')
define m3 = Character('毛毛_不解')
define m4 = Character('毛毛_快乐')
define m5 = Character('毛毛_苦涩')
define m6 = Character('毛毛_尴尬')

define c1 = Character('小孩_正常')
define c2 = Character('小孩_思考')
define c3 = Character('小孩_好奇')
define c4 = Character('小孩_快乐')
define c5 = Character('小孩_失望')

define o1 = Character('智者_正常')
define o2 = Character('智者_思考')
define o3 = Character('智者_不解')
define o4 = Character('智者_快乐')
define o5 = Character('智者_失望')

define s = Character("我")
define n = Character("画外音")

define chemlab = Background('化学实验室')
define MgOxidation = Object('氧化镁')
...
label start
    ...
    m1 "在化学反应中，其实是两种变化同时发生。"
    m1 "物质变化是主要的现象，能量变化只是伴随现象？"
    z1 "不完全是。物质变化和能量变化是相互联系的。很多反应需要吸收能量才能开始，这叫**“活化能”**。能量变化也会影响反应的快慢——"
    z3 "那边的家伙，你在做什么？"
    s "（环顾四周）啊？你是说我？？"
    "怎么办...怎么办...我是来做什么的？？我怎么知道啊，又没有人告诉我！"
    m1 "喂，小张，你不要吓到别人了！"
    show m2 at right
    m1 "同学，请问你刚刚听到了我们的对话嘛？"
    s "嗯，你们刚刚是在讨论化学反应中的两大变化...？"
    n "（沉默）"
    s "哎哎哎？怎么尬住了...不是吧..."
    show m1 at right
    m1 "你是新加入我们科学游戏系统的同学吧？"
    s "什么什么？？我是吗？"
    z1 "（盯）"
    n "犹豫什么。你是。"
    ...
    s "我叫[name]"
    m1 "很高兴认识你，[name]。我叫毛毛，刚刚在和我说话的是小张。之后我们会一起学习科学，构建科学知识体系。"
...
label refer_back_conclusion:
    ...
    judgement = judge(answers, set = true, ["能量", "物质"])
        if judgement:
